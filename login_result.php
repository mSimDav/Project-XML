...
if(($_POST['nume']==$data->nume) && ($_POST['parola']==$data->parola)){
  ...
  echo "Welcome ".$data->nume."!";?>
        ...
        <br><br><br>
         <a href="modifica.php" class="button">Modifica baza de date</a>
         
         <br><br><br>
         <a href="dtd/dtd.php" class="button">DTD</a> and
         
         <a href="session/session.php" class="button">Session</a>
         <br><br><br>
         <a href="mathML_SVG/index.php" class="button">MathML and SVG</a> 
         <br><br>
