...
session_start();
 ...
 $a=$xml->date[0]->title;
 $b=$xml->date[0]->description;
  $c=$xml->date[0]->image;
echo "Data ".$a. "and ".$b. "and ".$c." was loaded into session"; 
$_SESSION['title']=(string)$a; 
$_SESSION['description']=(string)$b; 
$_SESSION['image']=(string)$c; 
?>
        
       <br><br><br>
        <a href="session.php" class="button">Back</a>
