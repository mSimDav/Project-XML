...
Description: <br>
<input type = "text" name = "description" value="<?php echo $date->description; ?>"> <br><br>
Image: <br>
 <input type="file" name="image"><br><br>
 <img src="<?php echo $date->image;?>" class="center" width='100' height='100'><br><br>
